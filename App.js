...
const Restcards = (props) =>{
 ...
 const resObj=[{
    ...
    "cloudinaryImageId": "c8a1da887a7f5dad63a36c6fdbd361f2",
    ...
    "id": "346575",
    "name": "Food of Dreams",
    "cloudinaryImageId": "mpqzjxzkvueanoviaoxb",
    "locality": "3nd Phase",
    "areaName": "Ashok Vihar",
    ...
    "id": "383937",
    "name": "Gulab",
    "cloudinaryImageId": "tph4aohqlvmiphcwi0fo",
    "locality": "F Block",
    "areaName": "GTB Nagar",
        ...
        <div className="container">
            ...
            <div className="cardcontainer">
            {
                resObj.map((restaurant)=>(
                    <Restcards key={restaurant.id} resdata={restaurant}/>
                ))
            }
            </div>  
        </div>
